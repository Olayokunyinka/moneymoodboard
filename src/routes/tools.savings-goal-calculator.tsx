...
const DESC = "See exactly how long it'll take to hit your savings goal at your current contribution rate — and what'd happen if you bumped it up.";
...
export const Route = createFileRoute("/tools/savings-goal-calculator")({
  ...
  component: SavingsGoalStub,
});

function SavingsGoalStub() {
  return (
    <div className="mx-auto max-w-3xl px-4 md:px-6 pt-6 pb-16">
      ...
      <div className="mt-10 rounded-2xl border border-border bg-card p-8 text-center">
        ...
        <div className="mt-6 flex flex-wrap gap-3 justify-center">
          ...
          <Button asChild variant="outline"><Link to="/tools/emergency-fund-calculator">Try our Emergency Fund Calculator</Link></Button>
        </div>
      </div>
